...
-- NOTA: La base de datos ya fue creada por PostgreSQL desde las variables de entorno
-- Este script solo crea las tablas, índices y vistas

-- =====================================================
-- NOTA IMPORTANTE
-- =====================================================
-- Los ENUMS (tipos de datos personalizados) ya fueron creados
-- en el script 01-init-schema.sql que se ejecuta primero.
-- Este script solo crea las tablas, índices, triggers y vistas.
