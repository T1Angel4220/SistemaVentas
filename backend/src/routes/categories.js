...
router.post('/', authenticate, authorize('administrador'), CategoriesController.createCategory);     // POST /api/categories - Crear categoría
router.put('/:id', authenticate, authorize('administrador'), CategoriesController.updateCategory); // PUT /api/categories/:id - Actualizar categoría
