  ...
  if (!token) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="px-8 py-6 bg-gradient-to-r from-red-500 to-red-600 text-white text-center">
            <Shield className="h-12 w-12 mx-auto mb-3" />
            <h2 className="text-xl font-bold">Token Inválido</h2>
            <p className="text-red-100 mt-2">El enlace de recuperación no es válido</p>
          </div>
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="px-8 py-6 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-center">
            ...
            <p className="text-blue-100 mt-2">Crea una contraseña segura para tu cuenta</p>
          </div>
